...
let z:null; // data type of z will be explicitly to null type
z=null;
console.log(typeof z);

let a = 10n; // data type of a will be implicitly set to bigInt
let b = true; // data type of b will be implicitly set to Boolean
let c:any; // explicitly data of c  is set to ANY
// tsc will allow you to assign anything to c. 
let d:string; // explicitly data type of d set to string
d = "great";
let e:boolean; // explicitly data type of e set to boolean 
}
